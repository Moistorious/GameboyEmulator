...
impl GbMemory {
    ...
    pub fn read_u8(&self, address: u16) -> u8 {
        match address {
            ...
            0x0100..=0x3FFF => self.cartridge.read(address), // From cartridge, usually a fixed bank
            0x4000..=0x7FFF => self.cartridge.read(address), // From cartridge, switchable bank via mapper
            0x8000..=0x9FFF => self.vram[(address - 0x8000) as usize], // In CGB mode, switchable bank 0/1
            0xA000..=0xBFFF => self.cartridge.read(address), // External RAM from cartridge
